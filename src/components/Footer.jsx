          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1 flex flex-col h-full">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.youtube.com/@AegAkron" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#FF0000] hover:bg-gray-100 transition-all shadow-sm">
