  ...
  return (
    <div>
      <PageHero
        ...
        backgroundImage="https://images.unsplash.com/photo-1581092334651-ddf26d9a09d0?q=80&w=2940&auto=format&fit=crop"
      />

      {/* Services Grid - Matching Homepage Design */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:gap-20">
            <div className="lg:w-1/2 mb-12 lg:mb-0 text-center lg:text-left">
              <h2 className="text-4xl font-black text-gray-900 mb-6 tracking-tighter uppercase italic">Why Choose AECS?</h2>
              <p className="text-lg text-gray-600 leading-relaxed font-medium">
                We combine decades of domain expertise across automotive, marine, and medical sectors with modern CAD, CAM, and AI-driven design tools. We don't just draft plans—we engineer manufacturable reality.
              </p>
            </div>
            <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { title: "20+ Years Experience", desc: "Trusted by global OEMs for complex, precision engineering work." },
                { title: "ISO 9001:2015", desc: "Certified quality management processes across all services." },
                { title: "Multi-Domain Expertise", desc: "Automotive, marine, medical, and consumer product development." },
                { title: "End-to-End Delivery", desc: "From initial concept all the way to manufacturing support." }
              ].map((item, i) => (
                <div key={i} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 hover:border-brand-primary hover:shadow-lg transition-all">
                  <h4 className="font-black text-gray-900 uppercase tracking-tight mb-2">{item.title}</h4>
